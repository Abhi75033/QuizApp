...
function answerCheckera(){
  ...
  if (userClickedOption == correctAnswer){
    ...
    document.querySelector('#option-a').innerHTML = 'Incorrect'
    scoreDisplay.innerText = scoreCounter;
    setTimeout(nextQuestion, 750);
  }
}
...
function answerCheckerb(){
  ...
  if (userClickedOption == correctAnswer){
    ...
    document.querySelector('#option-b').innerHTML = 'Incorrect'
    scoreDisplay.innerText = scoreCounter;
    setTimeout(nextQuestion, 750);
  }
}
...
function answerCheckerc(){
  ...
  if (userClickedOption == correctAnswer){
    ...
    document.querySelector('#option-c').innerHTML = 'Incorrect'
    scoreDisplay.innerText = scoreCounter;
    setTimeout(nextQuestion, 750);
  }
}
...
function answerCheckerd(){
  ...
  if (userClickedOption == correctAnswer){
    ...
    document.querySelector('#option-d').innerHTML = 'Incorrect'
    scoreDisplay.innerText = scoreCounter;
    setTimeout(nextQuestion, 750);
  }
}
